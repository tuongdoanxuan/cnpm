...
public class FacadeController implements ActionListener, KeyListener {
	...
	public FacadeController(FlappyBird view, Bird bird, GameStatus status, Enviroment env, ScorePanel scorePanel) {
		this.view = view;
		this.bird = bird;
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_SHIFT) {
			gameStatus.setState(GameStatus.GameState.WAIT);
		}else if(gameStatus.getState()==GameStatus.GameState.WAIT)
